...
async def get_users(
    ...
    """
    try:
        result = await user_management_service.get_users_list(
            db=db,
            skip=skip,
            limit=limit,
            search=search,
...
async def update_my_profile(
    ...
    try:
        ...
        updated_user = await user_management_service.get_user_by_id(
...
async def update_user(
    ...
    try:
        ...
        if user_updates:
            await user_management_service.update_user(
                db=db, user_id=user_id, **user_updates
            )
...
async def delete_user(
    ...
    try:
        ...
        success = await user_management_service.delete_user(
...
async def activate_user(
    ...
    """
    try:
        success = await user_management_service.activate_user(
...
async def deactivate_user(
    ...
    try:
        ...
        success = await user_management_service.deactivate_user(

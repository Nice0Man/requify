...
from app.services.admin_service import MetricsService
...
async def get_metrics_timeseries(
    ...
    *,
    ...
    """
    try:
        metrics_data = await MetricsService.get_metrics_timeseries(
...
async def get_application_metrics(
    ...
    """
    try:
        metrics = await MetricsService.get_application_metrics()
...
async def get_error_metrics(current_user: CurrentUserDep):
    ...
    """
    try:
        metrics = await MetricsService.get_error_metrics()
...
async def get_error_details(
    ...
    """
    try:
        details = await MetricsService.get_error_details(
...
async def get_performance_metrics(current_user: CurrentUserDep):
    ...
    """
    try:
        metrics = await MetricsService.get_performance_metrics()
...
async def get_custom_metrics(current_user: CurrentUserDep):
    ...
    """
    try:
        metrics = await MetricsService.get_custom_metrics()

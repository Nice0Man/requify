...
class TestCoverageCalculator(IMetricCalculator):
    ...
    async def calculate(
        ...
        tested_req_query = select(func.count(func.distinct(Requirement.id))).select_from(
...
class AnalyticsService(BaseService):
    ...
    def _setup(self):
        ...
        if not self._initialized:
            ...
            self.register_metric_calculator("requirements", RequirementCountCalculator())
    ...
    async def get_dashboard_stats(
        ...
        try:
            self._log_operation("get_dashboard_stats", {
                "user_id": user_id,
    ...
    async def calculate_metric(
        ...
        try:
            self._log_operation("calculate_metric", {
            ...
            if not calculator:
                raise AnalyticsServiceError(f"Metric calculator '{metric_name}' not found")

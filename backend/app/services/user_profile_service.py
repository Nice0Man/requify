...
class UserProfileRepository:
    ...
    async def create_for_user(
        ...
        return await self.crud.create_for_user(
            db, obj_in=profile_data, user_id=user_id
        )
...
class UserProfileService(BaseService):
    ...
    async def get_user_profile(
        ...
        """
        try:
            self._log_operation("get_user_profile", {
                "user_id": user_id, 
    ...
    async def get_current_user_profile(
        ...
        try:
            self._log_operation("get_current_user_profile", {
    ...
    async def create_or_update_profile(
        ...
        """
        try:
            self._log_operation("create_or_update_profile", {
                "user_id": user_id,
                "current_user_id": current_user.id,
            ...
            validation_result = self._validate_profile_data(profile_data, validator_type)
    ...
    async def update_profile(
        ...
        """
        try:
            self._log_operation("update_profile", {
                "user_id": user_id,
                "current_user_id": current_user.id
            })
            ...
            if hasattr(update_data, '__dict__'):
                ...
                validation_result = self._validate_profile_data(temp_data, validator_type)
                if not validation_result.is_valid:
                    raise ValidationError(
                        f"Profile validation failed: {', '.join(validation_result.errors)}"
                    )
    ...
    async def delete_profile(
        ...
        """
        try:
            self._log_operation("delete_profile", {
                "user_id": user_id,
                "current_user_id": current_user.id
            })

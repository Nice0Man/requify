...
class CRUDTestCase(CRUDBase[TestCase, TestCaseCreate, TestCaseUpdate]):
    ...
    async def get_statistics(
        ...
        *,
        ...
        return {
            ...
            "automation_percentage": (automated_count / total * 100) if total > 0 else 0
        }
    ...
    async def get_ready_for_execution(
        ...
        *,
        ...
        query = query.offset(skip).limit(limit).order_by(TestCase.priority.desc(), TestCase.created_at.asc())

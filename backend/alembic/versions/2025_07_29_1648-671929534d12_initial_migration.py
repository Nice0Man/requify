...
Revision ID: 671929534d12
Revises:
Create Date: 2025-07-29 16:48:05.623885
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "avatar_url", sa.String(length=500), nullable=True, comment="URL аватара пользователя"
        ),
        sa.Column(
            "role",
            sa.String(length=20),

...
class DomainEndpointTester:
    ...
    def __init__(self, base_url: str = "http://localhost:8000"):
        ...
        self.domain_endpoints = {
            "auth": [
                {"method": "POST", "path": "/auth/login", "requires_auth": False, "description": "Admin login"},
                {"method": "GET", "path": "/auth/me", "requires_auth": True, "description": "Current user info"},
                {"method": "POST", "path": "/auth/logout/simple", "requires_auth": True, "description": "Simple logout"},
                {"method": "POST", "path": "/auth/validate-current-token", "requires_auth": True, "description": "Validate current token"},
                {"method": "POST", "path": "/auth/refresh", "requires_auth": False, "description": "Refresh token"},
                {"method": "POST", "path": "/auth/password/change", "requires_auth": True, "description": "Change password"},
                {"method": "POST", "path": "/auth/password/reset", "requires_auth": False, "description": "Reset password"},
                {"method": "POST", "path": "/auth/email/request", "requires_auth": False, "description": "Email verification"},
                {"method": "GET", "path": "/auth/sessions/", "requires_auth": True, "description": "User sessions"},
            ],
            "identity": [
                {"method": "GET", "path": "/identity/users/", "requires_auth": True, "description": "Get users list"},
                {"method": "GET", "path": "/identity/users/me", "requires_auth": True, "description": "Get my profile"},
                {"method": "GET", "path": "/identity/roles/", "requires_auth": True, "description": "Get roles"},
                {"method": "GET", "path": "/identity/permissions/", "requires_auth": True, "description": "Get permissions"},
                {"method": "GET", "path": "/identity/permissions/my-permissions", "requires_auth": True, "description": "My permissions"},
                {"method": "GET", "path": "/identity/profiles/me", "requires_auth": True, "description": "My extended profile"},
            ],
            "organizations": [
                {"method": "GET", "path": "/organizations/companies/", "requires_auth": True, "description": "Get companies"},
                {"method": "GET", "path": "/organizations/companies/my", "requires_auth": True, "description": "My company"},
                {"method": "GET", "path": "/organizations/departments/", "requires_auth": True, "description": "Get departments"},
                {"method": "GET", "path": "/organizations/teams/", "requires_auth": True, "description": "Get teams"},
                {"method": "GET", "path": "/organizations/teams/my", "requires_auth": True, "description": "My teams"},
            ],
            "projects": [
                {"method": "GET", "path": "/projects/", "requires_auth": True, "description": "Get projects"},
                {"method": "GET", "path": "/projects/requirements/", "requires_auth": True, "description": "Get requirements"},
                {"method": "GET", "path": "/projects/releases/", "requires_auth": True, "description": "Get releases"},
                {"method": "GET", "path": "/projects/analytics/", "requires_auth": True, "description": "Project analytics"},
            ],
            "quality": [
                {"method": "GET", "path": "/quality/testing/plans", "requires_auth": True, "description": "Test plans"},
                {"method": "GET", "path": "/quality/testing/cases", "requires_auth": True, "description": "Test cases"},
                {"method": "GET", "path": "/quality/testing/executions", "requires_auth": True, "description": "Test executions"},
                {"method": "GET", "path": "/quality/specifications/", "requires_auth": True, "description": "Specifications"},
                {"method": "GET", "path": "/quality/reports/", "requires_auth": True, "description": "Quality reports"},
            ],
            "collaboration": [
                {"method": "GET", "path": "/collaboration/comments/", "requires_auth": True, "description": "Comments"},
                {"method": "GET", "path": "/collaboration/relationships/", "requires_auth": True, "description": "Relationships"},
                {"method": "GET", "path": "/collaboration/notifications/", "requires_auth": True, "description": "Notifications"},
                {"method": "GET", "path": "/collaboration/activity/", "requires_auth": True, "description": "Activity feed"},
            ],
            "analytics": [
                {"method": "GET", "path": "/analytics/dashboard/", "requires_auth": True, "description": "Dashboard analytics"},
                {"method": "GET", "path": "/analytics/reports/", "requires_auth": True, "description": "Analytics reports"},
                {"method": "GET", "path": "/analytics/metrics/", "requires_auth": True, "description": "System metrics"},
            ],
            "configuration": [
                {"method": "GET", "path": "/configuration/reference/", "requires_auth": True, "description": "Reference data"},
                {"method": "GET", "path": "/configuration/settings/", "requires_auth": True, "description": "Settings"},
                {"method": "GET", "path": "/configuration/workflows/", "requires_auth": True, "description": "Workflows"},
            ],
            "system": [
                {"method": "GET", "path": "/system/health", "requires_auth": True, "description": "System health"},
                {"method": "GET", "path": "/system/metrics", "requires_auth": True, "description": "System metrics"},
                {"method": "GET", "path": "/system/admin/users", "requires_auth": True, "description": "Admin users"},
                {"method": "GET", "path": "/system/backup/", "requires_auth": True, "description": "System backups"},
                {"method": "GET", "path": "/system/audit/", "requires_auth": True, "description": "Audit logs"},
            ]
        }
    ...
    async def test_endpoint(self, endpoint: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "success": response.status_code < 500,  # Anything below 500 is considered success for testing
    ...
    async def test_all_domains(self) -> Dict[str, Any]:
        ...
        for domain_name in self.domain_endpoints.keys():
            ...
            print(f"✅ {domain_name}: {summary.get('success', 0)}/{summary.get('total', 0)} endpoints successful")
    ...
    def print_results(self, results: Dict[str, Any]):
        ...
        for domain_name, domain_result in results["domains"].items():
            ...
            print(f"   📈 {domain_summary['success']}/{domain_summary['total']} endpoints successful ({domain_summary['success_rate']:.1f}%)")
            
            # Show failed endpoints
            failed_endpoints = [ep for ep in domain_result["endpoints"] if not ep["success"]]
            if failed_endpoints:
                print(f"   ⚠️  Failed endpoints:")
                for ep in failed_endpoints:
                    status = ep["status_code"] if ep["status_code"] > 0 else "ERROR"
                    print(f"      - {ep['endpoint']} ({status}): {ep.get('error', 'HTTP Error')}")
            
            # Show successful endpoints
            success_endpoints = [ep for ep in domain_result["endpoints"] if ep["success"]]
            if success_endpoints:
                print(f"   ✅ Successful endpoints:")
                for ep in success_endpoints:
                    print(f"      - {ep['endpoint']} ({ep['status_code']}): {ep['description']}")

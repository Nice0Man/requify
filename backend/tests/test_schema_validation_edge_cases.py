...
from app.schemas.user import (
    UserCreate, UserUpdate, UserBase, UserDetailed,
...
class TestUserSchemaValidationEdgeCases:
    ...
    @pytest.mark.parametrize("forbidden_domain", [
        "temp-mail.org",
        "10minutemail.com", 
        "guerrillamail.com",
        "mailinator.com",
    ...
    def test_reserved_usernames_rejected(self, reserved_username):
        ...
        with pytest.raises(ValidationError, match=f"Username '{reserved_username}' is reserved"):
            UserCreate(
    ...
    def test_password_confirmation_mismatch(self):
        ...
        with pytest.raises(ValidationError, match="Password and confirm_password do not match"):
            UserCreate(
                username="testuser",
                email="test@example.com",
                name="Test User",
    ...
    def test_password_contains_username(self):
        ...
        with pytest.raises(ValidationError, match="Password should not contain username"):
            UserCreate(
                username="testuser",
                email="test@example.com",
                name="Test User",
    ...
    def test_password_contains_email(self):
        ...
        with pytest.raises(ValidationError, match="Password should not contain email address"):
            UserCreate(
                username="testuser",
    ...
    def test_company_id_validation(self):
        ...
        with pytest.raises(ValidationError, match="Company ID must be a positive integer"):
            UserCreate(
                username="testuser",
                email="test@example.com",
                name="Test User",

...
export const usePermissionGuard = () => {
  ...
  const checkAccess = (options: {
    ...
    // Check role-based access
    if (roles.length > 0 && !permissions.hasRole(roles)) {
      return false;
    }
...
export const ProjectsWrite: React.FC<{ children: React.ReactNode; fallback?: React.ReactNode }> = ({
  children,
  fallback,
}) => (
...
export const RequirementsWrite: React.FC<{ children: React.ReactNode; fallback?: React.ReactNode }> = ({
  children,
  fallback,
}) => (
...
export const ReleasesWrite: React.FC<{ children: React.ReactNode; fallback?: React.ReactNode }> = ({
  children,
  fallback,
}) => (
...
export const TestingExecute: React.FC<{ children: React.ReactNode; fallback?: React.ReactNode }> = ({
  children,
  fallback,
}) => (

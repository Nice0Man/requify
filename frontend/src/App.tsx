...
const ProjectDetailsPage = React.lazy(() => import('@/features/projects/pages/ProjectDetailsPage'));
const RequirementsPage = React.lazy(() => import('@/features/requirements/pages/RequirementsPage'));
const RequirementDetailsPage = React.lazy(() => import('@/features/requirements/pages/RequirementDetailsPage'));
const TestingPage = React.lazy(() => import('@/features/testing/pages/TestingPage'));
const TestRunDetailsPage = React.lazy(() => import('@/features/testing/pages/TestRunDetailsPage'));
const ReleasesPage = React.lazy(() => import('@/features/releases/pages/ReleasesPage'));
const ReleaseDetailsPage = React.lazy(() => import('@/features/releases/pages/ReleaseDetailsPage'));
...
const ApiOverviewPage = React.lazy(() => import('@/features/dashboard/pages/ApiOverviewPage'));
const StartPage = React.lazy(() => import('@/features/dashboard/pages/StartPage'));

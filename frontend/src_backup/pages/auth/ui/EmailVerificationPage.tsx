...
const EmailVerificationPage: React.FC = () => {
  ...
  const handleVerifyEmail = async (token: string) => {
    ...
    console.log(
      "handleVerifyEmail called with token:",
    ...
    try {
      ...
      const response = await authApi.confirmEmailVerification(verifyRequest);
  ...
  const handleResendVerification = async () => {
    ...
    try {
      ...
      const response = await authApi.requestEmailVerification(resendRequest);

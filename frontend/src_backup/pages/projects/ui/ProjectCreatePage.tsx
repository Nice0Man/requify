...
// FSD imports
import { projectsApi } from "@/entities/project/api";
import { ProjectCreate, ProjectStatus } from "@/entities/project/model/types";
import { ProjectValidation, FormErrors } from "@/entities/project/model/types";
    ...
    try {
      ...
      if (error?.response?.data?.detail) {
        if (Array.isArray(error.response.detail)) {
          ...
          error.response.detail.forEach((err: any) => {
            if (err.loc && err.msg) {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              helperText={
                errors.description ||
                "Describe the project goals, scope, and objectives (optional)"
              }
